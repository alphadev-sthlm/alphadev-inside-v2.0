  ...
  app.get("/", (req, res, next) => {
    ...
    res.render("home", {
        ...
        "one_of_us": {
          ...
          "first_section": "Den här sidan riktar sig till dig som är lite nyfiken på hur det är att jobba på Alphadev. Du har kanske stött på någon",
          "link": "Alphadevare",
          "second_section": "i något projekt, kanske hört det pratas om oss i kafferummet, eller bara random googlat dig hit (yeah, right). Börja med att kika på",
