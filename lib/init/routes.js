    ...
    res.render("home", {
      ...
      "join_us": {
        ...
        "link": "BOKA EN KAFFE"
			...
			"employer_of_the_future": {
        "title": "Framtidens arbetsgivare",
        "text": "Som Alphadevare kan du antingen vara traditionellt anställd, eller ha ett eget företag i botten - det är ditt egna val.​ Alldeles oavsett behåller du 80% av allt vi fakturerar för dig och du bestämmer alltid själv vad pengarna ska användas till.​"
      },
      uspar,
      jobOpportunity,
      footer
