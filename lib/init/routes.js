...
module.exports = function routes(app) {
  app.get("/", (req, res, next) => {
    ...
    res.render("home", {
      ...
      "job_opportunity": {
        "title": "Här kommer länk till säljansvarigssidan finnas",
      },
      "uspar": uspar, ...footer
    });
  });

  app.get("/saljansvarig", (req, res, next) => {
    const footer = {
      "footer": {
        "tel": "070-296 00 05",
        "mail": "HELLO@ALPHADEV.SE",
        "link": "hello@alphadev.se",
        "adress": "KUNGSGATAN 6, 111 43 STOCKHOLM"
      }
    };
    res.render("sales_responsible", { ...salesResponsible, ...footer, ...backToInside});
  });
};
